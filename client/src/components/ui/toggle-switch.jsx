...
// Skeuomorphic toggle switch (adapted from uiverse-style snippet).
// Controlled component: pass `checked` and `onChange(nextChecked)`.
const Switch = ({ id = 'toggle-switch', checked = false, onChange, label = 'Toggle', title }) => {
  return (
